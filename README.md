# Repositório do curso "SQL Database Specialist" DIO
...
2 - Desafio Construindo um Esquema Conceitual para Banco De dados
...
Arquivo: Construindo um Esquema Conceitual para Banco De dados.pdf
